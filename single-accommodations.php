			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<ul class="list-unstyled">
						<li><a href="#" title=""><?php echo $options['city']; ?> <small>(<?php echo $_COOKIE['bookandpay_checkin']; ?> - <?php echo $_COOKIE['bookandpay_checkout']; ?>)</small></a><li>
		...
		<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9" >
			<div class="row">
				<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8" >
					...
					Alloggi <?php the_terms( get_the_ID(), 'types'); ?> da <?php echo $max_pax; ?> <i class="fa fa-user"></i> - <i class="fa fa-map-marker"></i><?php echo $options['city']; ?>: <?php the_terms( get_the_ID(), 'areas'); ?> 
				</div>
				    ...
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
						...
						<?php else : ?>
				 		...
				 		<p><?php _e("<!--:it-->Compilate il seguente modulo per richiedere informazioni<!--:--><!--:en-->Please submit this module to ask availability. We will contact you as soon as possible.<!--:-->"); ?>. In alternativa o se avete delle domande inviate una mail a <a href="mailto:booking@appartamenti-lefkada.com">booking@beb-in-italy.com</a>
				 		<?php endif ?></p> <hr />
				 		<?php if(function_exists(BookingBsForm)) BookingBsForm($post->ID,'it'); ?>
